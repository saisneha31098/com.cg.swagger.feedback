package com.cg.swagger.feedback.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> AddressNotFoundHandling(UnknownUserException exception){
	ErrorDetails errormessage=new ErrorDetails("Feedback not found",exception.getMessage() ,new Date());
