...
public class GlobalExceptionHandlerP {
	...
	public ResponseEntity<?> AddressNotFoundHandling(PatientNotFoundException exception){
	ErrorDetails errormessage=new ErrorDetails("PatientNotFound",exception.getMessage() ,new Date());
